...
ALL_CONFIGURATIONS = [
    ...
    ("SVM: Text Only",                 "lin_svc -t 5 -c -n -p 0.4 -txt"         ),
    ("SVM: All Features",              "lin_svc -t 5 -c -n -p 0.4"              ),
    ("SVM: Tf-Idf, Text Only",         "lin_svc -t 5 -c -n -p 0.4 -tf -txt"     ),
    ("SVM: Tf-Idf, All Features",      "lin_svc -t 5 -c -n -p 0.4 -tf"          ),
    ("SVM: K-Best, Text Only",         "lin_svc -t 5 -c -n -p 0.4 -kb 200 -txt" ),
    ("SVM: K-Best, All Features",      "lin_svc -t 5 -c -n -p 0.4 -kb 200"      ),
...
TFIDF_CONFIGURATIONS = [
    ...
    ("SVM: Text Only",         "lin_svc -t 5 -c -n -p 0.4 -tf -txt"     ),
    ("SVM: All Features",      "lin_svc -t 5 -c -n -p 0.4 -tf"          ),
...
KBEST_CONFIGURATIONS = [
    ...
    ("SVM: Text Only",         "lin_svc -t 5 -c -n -p 0.4 -kb 200 -txt" ),
    ("SVM: All Features",      "lin_svc -t 5 -c -n -p 0.4 -kb 200"      ),
